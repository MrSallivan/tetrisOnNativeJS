    ...
    <div class="game-content__inner">
        ...
        <div class="game-content-content">
            <div class="game-content__info">
                <div class="game-content__next next">
            ...
            <div class="game-content__score score">
            ...
            <div class="game-controls">
                <button class="sketch-button top"><span><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" width="24"
                                                           height="24" viewBox="0 0 24 24"><path
                        d="M0 16.67l2.829 2.83 9.175-9.339 9.167 9.339 2.829-2.83-11.996-12.17z"/></svg></span></button>
                <button class="sketch-button bottom"><span><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg"
                                                              width="24"
                                                              height="24" viewBox="0 0 24 24"><path
                        d="M0 16.67l2.829 2.83 9.175-9.339 9.167 9.339 2.829-2.83-11.996-12.17z"/></svg></span></button>
                <button class="sketch-button left"><span><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24"><path
                        d="M0 16.67l2.829 2.83 9.175-9.339 9.167 9.339 2.829-2.83-11.996-12.17z"/></svg></span></button>
                <button class="sketch-button right"><span><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg"
                                                             width="24"
                                                             height="24" viewBox="0 0 24 24"><path
                        d="M0 16.67l2.829 2.83 9.175-9.339 9.167 9.339 2.829-2.83-11.996-12.17z"/></svg></span></button>
            </div>
